...
SPACY_MODEL_DIR = os.path.join(home, "jupyter_text2code/jupyter_text2code_serverextension/models/ner")
FAISS_INDEX_PATH = os.path.join(home, "jupyter_text2code/jupyter_text2code_serverextension/models/intent_index.idx")
INTENT_DF_PATH = "E:/on_nine_ai/t2c/jupyter-text2code/jupyter_text2code/jupyter_text2code_serverextension/data/ner_templates.csv"  
