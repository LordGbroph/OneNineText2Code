...
def index(request):
    if "GET" == request.method:
        onenineStorage = FileSystemStorage()
        #onenineStorage.save(uploaded_file.name, uploaded_file)
    ...
    text_returned = CG.generate_code("import all libraries")
    print(text_returned)
    text_returned = CG.generate_code("install matplotlib and pandas")
    print(text_returned)
...
def get_query_data(request):
    ...
    return render(request,'myapp/index.html',{'qry': qry})
...
home = os.path.dirname(__file__) # e:/onenine/
print("+++++++++++++++++++++++++++++++++++++++")
print(home)
...
SPACY_MODEL_DIR = os.path.join(home, "jupyter_text2code_serverextension/models/ner")
FAISS_INDEX_PATH = os.path.join(home, "jupyter_text2code_serverextension/models/intent_index.idx")
INTENT_DF_PATH = r"C:/Users/garre/senior/src/OneNine/myapp/jupyter_text2code_serverextension/data/ner_templates.csv"  
