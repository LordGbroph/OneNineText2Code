...
SPACY_MODEL_DIR = os.path.join(home, "C:\Users\garre\AppData\Local\Packages\PythonSoftwareFoundation.Python.3.9_qbz5n2kfra8p0\LocalCache\local-packages\Python39\site-packages\en_core_web_sm")
FAISS_INDEX_PATH = os.path.join(home, "models/intent_index.idx")
INTENT_DF_PATH = os.path.join(home, r"data/ner_templates.csv")
